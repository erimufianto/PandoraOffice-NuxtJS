<template>
  <b-card :header="caption">
    ...
    <li class="page-item previous"><a class="page-link" ><i class="fa fa-angle-left" aria-hidden=""></i></a></li>
        <li class="page-item"><a class="page-link" href="#">1</a></li>
        <li class="page-item"><a class="page-link" href="#">2</a></li>
        <li class="page-item"><a class="page-link" href="#">3</a></li>
    <li class="page-item next"><a class="page-link" click=@nextPage><i class="fa fa-angle-right" aria-hidden=""></i></a></li>
  </b-card>
</template>
